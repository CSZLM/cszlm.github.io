"use strict";
(self.webpackChunk_hydrooj_ui_default = self.webpackChunk_hydrooj_ui_default || []).push([[126], {
    74324: (x4,Nt,Ft)=>{
        Ft.r(Nt),
        Ft.d(Nt, {
            default: ()=>v4
        ...
        class A {
            constructor(e, t) {
                ...
                var a = "KaTeX parse error: " + e, n, s = t && t.loc;
                if (s && s.start <= s.end) {
                    var u = s.lexer.input;
                    n = s.start;
                    var h = s.end;
                    n === u.length ? a += " at end of input: " : a += " at position " + (n + 1) + ": ";
                    var c = u.slice(n, h).replace(/[^]/g, "$&\u0332"), p;
                    n > 15 ? p = "\u2026" + u.slice(n - 15, n) : p = u.slice(0, n);
                    var g;
                    h + 15 < u.length ? g = u.slice(h, h + 15) + "\u2026" : g = u.slice(h),
                    a += p + c + g
                }
                var y = new Error(a);
                return y.name = "ParseError",
                y.__proto__ = A.prototype,
                y.position = n,
                y
            }
        }
        ...
        var f1 = function(e, t) {
          ...
          , y1 = /[&><"']/g;
        function x1(r) {
            return String(r).replace(y1, e=>b1[e])
        }
        var qt = function r(e) {
        ...
        class He {
            ...
            isTrusted(e) {
                e.url && !e.protocol && (e.protocol = q.protocolFromUrl(e.url));
        ...
        class F0 {
            ...
            sup() {
                return y0[M1[this.id]]
            }
            sub() {
                return y0[z1[this.id]]
            }
            fracNum() {
                return y0[B1[this.id]]
            }
            fracDen() {
                return y0[C1[this.id]]
            }
            cramp() {
                return y0[E1[this.id]]
            }
            text() {
                return y0[T1[this.id]]
            }
            isTight() {
                return this.size >= 2
            }
        ...
        var Pe = 0
          ...
          , j0 = 6
          , r0 = 7
          , y0 = [new F0(Pe,0,!1), new F0(fe,0,!0), new F0(W0,1,!1), new F0(A0,1,!0), new F0(ae,2,!1), new F0(c0,2,!0), new F0(j0,3,!1), new F0(r0,3,!0)]
          , M1 = [ae, c0, ae, c0, j0, r0, j0, r0]
          , z1 = [c0, c0, c0, c0, r0, r0, r0, r0]
          , B1 = [W0, A0, ae, c0, j0, r0, j0, r0]
          , C1 = [A0, A0, c0, c0, r0, r0, r0, r0]
          , E1 = [fe, fe, A0, A0, c0, c0, r0, r0]
          , T1 = [Pe, fe, W0, A0, W0, A0, W0, A0]
          , N = {
            DISPLAY: y0[Pe],
            TEXT: y0[W0],
            SCRIPT: y0[ae],
        ...
        function D1(r) {
            for (var e = 0; e < Ge.length; e++)
                for (var t = Ge[e], a = 0; a < t.blocks.length; a++) {
                    var n = t.blocks[a];
                    if (r >= n[0] && r <= n[1])
                        return t.name
                }
        ...
        var pe = [];
        Ge.forEach(r=>r.blocks.forEach(e=>pe.push(...e)));
        function Rt(r) {
            for (var e = 0; e < pe.length; e += 2)
                if (r >= pe[e] && r <= pe[e + 1])
                    return !0;
            return !1
        }
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`;
        ...
        function Ve(r, e, t) {
            ...
            var a = r.charCodeAt(0)
              , n = x0[e][a];
            if (!n && r[0]in Ot && (a = Ot[r[0]].charCodeAt(0),
            n = x0[e][a]),
            !n && t === "text" && Rt(a) && (n = x0[e][77]),
            n)
                return {
                    depth: n[0],
                    height: n[1],
        ...
        var $1 = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]]
          , Lt = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488]
          , Ht = function(e, t) {
            return t.size < 2 ? e : $1[e - 1][t.size - 1]
        };
        class M0 {
            constructor(e) {
                this.style = void 0,
                ...
                this.sizeMultiplier = Lt[this.size - 1],
            ...
            havingBaseStyle(e) {
                e = e || this.style.text();
                var t = Ht(M0.BASESIZE, e);
                return this.size === t && this.textSize === M0.BASESIZE && this.style === e ? this : this.extend({
                    style: e,
                    size: t
                })
            }
            ...
            baseSizingClasses() {
                return this.size !== M0.BASESIZE ? ["sizing", "reset-size" + this.size, "size" + M0.BASESIZE] : []
            }
            fontMetrics() {
                return this._fontMetrics || (this._fontMetrics = U1(this.size)),
                this._fontMetrics
            }
            getColor() {
        ...
        var $e = {
          ...
          , j = function(e, t) {
            var a;
            if (e.unit in $e)
                a = $e[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
            else if (e.unit === "mu")
          ...
          , Ut = function(e) {
            var t = "<" + e;
            this.classes.length && (t += ' class="' + q.escape(q0(this.classes)) + '"');
            var a = "";
        ...
        class d0 {
            constructor(e, t, a, n, s, u, h, c) {
                ...
                this.style = c || {},
                this.maxFontSize = 0;
                var p = D1(this.text.charCodeAt(0));
                p && this.classes.push(p + "_fallback"),
                /[îïíì]/.test(this.text) && (this.text = W1[this.text])
            }
            hasClass(e) {
                return q.contains(this.classes, e)
            }
            toNode() {
                ...
                t.style.marginRight = M(this.italic)),
        ...
        class R0 {
            ...
            toNode() {
                ...
                return this.alternate ? t.setAttribute("d", this.alternate) : t.setAttribute("d", It[this.pathName]),
                t
            }
            toMarkup() {
        ...
        i(l, o, a0, "\u23B1", "\\rmoustache", !0),
        i(l, o, h0, "\u23B0", "\\lmoustache", !0),
        i(l, o, a0, "\u27EF", "\\rgroup", !0),
        i(l, o, h0, "\u27EE", "\\lgroup", !0),
        i(l, o, E, "\u2213", "\\mp", !0),
        i(l, o, E, "\u2296", "\\ominus", !0),
        ...
        i(l, d, f, "\u2251", "\\Doteq", !0),
        i(l, d, E, "\u2214", "\\dotplus", !0),
        i(l, d, E, "\u2216", "\\smallsetminus"),
        i(l, d, E, "\u22D2", "\\Cap", !0),
        i(l, d, E, "\u22D3", "\\Cup", !0),
        i(l, d, E, "\u2A5E", "\\doublebarwedge", !0),
        i(l, d, E, "\u229F", "\\boxminus", !0),
        i(l, d, E, "\u229E", "\\boxplus", !0),
        i(l, d, E, "\u22C7", "\\divideontimes", !0),
        i(l, d, E, "\u22C9", "\\ltimes", !0),
        i(l, d, E, "\u22CA", "\\rtimes", !0),
        i(l, d, E, "\u22CB", "\\leftthreetimes", !0),
        i(l, d, E, "\u22CC", "\\rightthreetimes", !0),
        i(l, d, E, "\u22CF", "\\curlywedge", !0),
        i(l, d, E, "\u22CE", "\\curlyvee", !0),
        i(l, d, E, "\u229D", "\\circleddash", !0),
        i(l, d, E, "\u229B", "\\circledast", !0),
        i(l, d, E, "\u22C5", "\\centerdot"),
        i(l, d, E, "\u22BA", "\\intercal", !0),
        i(l, d, E, "\u22D2", "\\doublecap"),
        i(l, d, E, "\u22D3", "\\doublecup"),
        ...
        i(l, o, F, "\u03C8", "\\psi", !0),
        i(l, o, F, "\u03C9", "\\omega", !0),
        i(l, o, F, "\u03B5", "\\varepsilon", !0),
        i(l, o, F, "\u03D1", "\\vartheta", !0),
        i(l, o, F, "\u03D6", "\\varpi", !0),
        i(l, o, F, "\u03F1", "\\varrho", !0),
        i(l, o, F, "\u03C2", "\\varsigma", !0),
        i(l, o, F, "\u03C6", "\\varphi", !0),
        i(l, o, E, "\u2217", "*", !0),
        i(l, o, E, "+", "+"),
        i(l, o, E, "\u2212", "-", !0),
        ...
        i(l, o, v, "\u2202", "\\partial", !0),
        i(l, o, E, "\u2298", "\\oslash", !0),
        i(l, d, E, "\u229A", "\\circledcirc", !0),
        i(l, d, E, "\u22A1", "\\boxdot", !0),
        i(l, o, E, "\u25B3", "\\bigtriangleup"),
        i(l, o, E, "\u25BD", "\\bigtriangledown"),
        i(l, o, E, "\u2020", "\\dagger"),
        i(l, o, E, "\u22C4", "\\diamond"),
        i(l, o, E, "\u22C6", "\\star"),
        i(l, o, E, "\u25C3", "\\triangleleft"),
        i(l, o, E, "\u25B9", "\\triangleright"),
        i(l, o, h0, "{", "\\{"),
        i(k, o, v, "{", "\\{"),
        ...
        i(l, o, Q, "\u2A06", "\\bigsqcup"),
        i(l, o, Q, "\u222B", "\\smallint"),
        i(k, o, K0, "\u2026", "\\textellipsis"),
        i(l, o, K0, "\u2026", "\\mathellipsis"),
        i(k, o, K0, "\u2026", "\\ldots", !0),
        i(l, o, K0, "\u2026", "\\ldots", !0),
        i(l, o, K0, "\u22EF", "\\@cdots", !0),
        i(l, o, K0, "\u22F1", "\\ddots", !0),
        ...
        i(l, o, v, "\xB0", "\\degree", !0),
        i(k, o, v, "\xB0", "\\degree"),
        i(k, o, v, "\xB0", "\\textdegree", !0),
        i(l, o, v, "\xA3", "\\pounds"),
        i(l, o, v, "\xA3", "\\mathsterling", !0),
        i(k, o, v, "\xA3", "\\pounds"),
        i(k, o, v, "\xA3", "\\textsterling", !0),
        i(l, d, v, "\u2720", "\\maltese"),
        i(k, d, v, "\u2720", "\\maltese");
        for (var Yt = '0123456789/@."', We = 0; We < Yt.length; We++) {
            var Wt = Yt.charAt(We);
            i(l, o, v, Wt, Wt)
        }
        for (var jt = '0123456789!@*()-=+";:?/.,', je = 0; je < jt.length; je++) {
            var Zt = jt.charAt(je);
            i(k, o, v, Zt, Zt)
        }
        for (var be = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", Ze = 0; Ze < be.length; Ze++) {
            var ye = be.charAt(Ze);
            i(l, o, F, ye, ye),
            i(k, o, v, ye, ye)
        }
        ...
        i(l, o, F, "h", "\u210E"),
        i(k, o, F, "h", "\u210E");
        for (var I = "", i0 = 0; i0 < be.length; i0++) {
            var _ = be.charAt(i0);
            I = String.fromCharCode(55349, 56320 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            I = String.fromCharCode(55349, 56372 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            I = String.fromCharCode(55349, 56424 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            I = String.fromCharCode(55349, 56580 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            I = String.fromCharCode(55349, 56736 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            I = String.fromCharCode(55349, 56788 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            I = String.fromCharCode(55349, 56840 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            I = String.fromCharCode(55349, 56944 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            i0 < 26 && (I = String.fromCharCode(55349, 56632 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I),
            I = String.fromCharCode(55349, 56476 + i0),
            i(l, o, F, _, I),
            i(k, o, v, _, I))
        }
        ...
        for (var U0 = 0; U0 < 10; U0++) {
            var I0 = U0.toString();
            I = String.fromCharCode(55349, 57294 + U0),
            i(l, o, F, I0, I),
            i(k, o, v, I0, I),
            I = String.fromCharCode(55349, 57314 + U0),
            i(l, o, F, I0, I),
            i(k, o, v, I0, I),
            I = String.fromCharCode(55349, 57324 + U0),
            i(l, o, F, I0, I),
            i(k, o, v, I0, I),
            I = String.fromCharCode(55349, 57334 + U0),
            i(l, o, F, I0, I),
            i(k, o, v, I0, I)
        }
        for (var Ke = "\xD0\xDE\xFE", Je = 0; Je < Ke.length; Je++) {
            var xe = Ke.charAt(Je);
            i(l, o, F, xe, xe),
            i(k, o, v, xe, xe)
        }
        var we = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["", "", ""], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]]
          , Kt = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]]
          , J1 = function(e, t) {
          ...
          , Q1 = function(e, t, a, n) {
            return n === void 0 && (n = []),
            a.font === "boldsymbol" && ke(e, "Main-Bold", t).metrics ? g0(e, "Main-Bold", t, a, n.concat(["mathbf"])) : e === "\\" || Y[t][e].font === "main" ? g0(e, "Main-Regular", t, a, n) : g0(e, "AMS-Regular", t, a, n.concat(["amsrm"]))
        }
          , _1 = function(e, t, a, n, s) {
            return s !== "textord" && ke(e, "Math-BoldItalic", t).metrics ? {
          ...
          , ea = function(e, t, a) {
            ...
            if (s.charCodeAt(0) === 55349) {
                ...
                if (c === "boldsymbol") {
                    ...
                    h ? (y = _t[c].fontName,
                    w = [c]) : (y = Se(c, t.fontWeight, t.fontShape),
                    w = [c, t.fontWeight, t.fontShape]);
                if (ke(s, y, n).metrics)
                    return g0(s, y, n, t, u.concat(w));
                if (Xt.hasOwnProperty(s) && y.slice(0, 10) === "Typewriter") {
                    for (var z = [], B = 0; B < s.length; B++)
                        z.push(g0(s[B], y, n, t, u.concat(w)));
                    return Qt(z)
                }
            }
            if (a === "mathord")
                return g0(s, "Math-Italic", n, t, u.concat(["mathnormal"]));
            if (a === "textord") {
                var T = Y[n][s] && Y[n][s].font;
                if (T === "ams") {
                    var D = Se("amsrm", t.fontWeight, t.fontShape);
                    return g0(s, D, n, t, u.concat("amsrm", t.fontWeight, t.fontShape))
                } else if (T === "main" || !T) {
                    var R = Se("textrm", t.fontWeight, t.fontShape);
                    return g0(s, R, n, t, u.concat(t.fontWeight, t.fontShape))
                } else {
                    var O = Se(T, t.fontWeight, t.fontShape);
                    return g0(s, O, n, t, u.concat(O, t.fontWeight, t.fontShape))
                }
            } else
                throw new Error("unexpected type: " + a + " in makeOrd")
        }
          , ta = (r,e)=>{
            if (q0(r.classes) !== q0(e.classes) || r.skew !== e.skew || r.maxFontSize !== e.maxFontSize)
                return !1;
          ...
          , ra = r=>{
            for (var e = 0; e < r.length - 1; e++) {
                var t = r[e]
                  , a = r[e + 1];
                t instanceof d0 && a instanceof d0 && ta(t, a) && (t.text += a.text,
          ...
          , ia = function(e, t) {
            return e instanceof ne ? s0([], [e], t) : e
        }
          , sa = function(e) {
          ...
          , la = function(e, t) {
            ...
            for (var g = [], y = n, w = n, x = n, z = 0; z < a.length; z++) {
                ...
                if (B.type === "kern")
                    ...
                    var T = B.elem
                      ...
                      , R = B.wrapperStyle || {}
                      , O = s0(D, [p, T], void 0, R);
                    O.style.top = M(-s - x - T.depth),
                    B.marginLeft && (O.style.marginLeft = B.marginLeft),
                    B.marginRight && (O.style.marginRight = B.marginRight),
                    g.push(O),
                    x += T.height + T.depth
                }
                y = Math.min(y, x),
            ...
            if (y < 0) {
                var U = s0([], [])
                  , G = s0(["vlist"], [U]);
                G.style.height = M(-y);
                var K = s0(["vlist-s"], [new d0("\u200B")]);
                H = [s0(["vlist-r"], [V, K]), s0(["vlist-r"], [G])]
            } else
                H = [s0(["vlist-r"], [V])];
            var $ = s0(["vlist-t"], H);
            return H.length === 2 && $.classes.push("vlist-t2"),
            $.height = w,
            $.depth = -y,
            $
        }
          , ua = (r,e)=>{
            var t = s0(["mspace"], [], e)
              , a = j(r, e);
            return t.style.marginRight = M(a),
            t
        }
          , Se = function(e, t, a) {
            var n = "";
        ...
        var ze = function(e) {
          ...
          , E0 = b.makeSpan
          , ca = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]
          , da = ["rightmost", "mrel", "mclose", "mpunct"]
          , fa = {
            display: N.DISPLAY,
            text: N.TEXT,
            script: N.SCRIPT,
          ...
          , e0 = function(e, t, a, n) {
            ...
            if (e.length === 1) {
                var g = e[0];
                g.type === "sizing" ? p = t.havingSize(g.size) : g.type === "styling" && (p = t.havingStyle(fa[g.style]))
            }
            var y = E0([n[0] || "leftmost"], [], t)
              , w = E0([n[1] || "rightmost"], [], t)
              , x = a === "root";
            return rr(s, (z,B)=>{
                var T = B.classes[0]
                  , D = z.classes[0];
                T === "mbin" && q.contains(da, D) ? B.classes[0] = "mord" : D === "mbin" && q.contains(ca, T) && (z.classes[0] = "mord")
            }
            , {
                node: y
            }, w, x),
            rr(s, (z,B)=>{
                var T = _e(B)
                  , D = _e(z)
                  , R = T && D ? z.hasClass("mtight") ? ma[T][D] : ha[T][D] : null;
                if (R)
                    return b.makeGlue(R, p)
            }
            , {
                node: y
            }, w, x),
          ...
          , rr = function r(e, t, a, n, s) {
            ...
            for (var u = 0; u < e.length; u++) {
                ...
                p ? a.node = h : s && h.hasClass("newline") && (a.node = E0(["leftmost"])),
                a.insertAfter = (y=>w=>{
                    e.splice(y + 1, 0, w),
                    u++
                }
          ...
          , ar = function(e) {
            return e instanceof ne || e instanceof Xe || e instanceof ie && e.hasClass("enclosing") ? e : null
        }
          , va = function r(e, t) {
            var a = ar(e);
            if (a) {
        ...
        function Be(r, e) {
            var t = E0(["base"], r, e)
              , a = E0(["strut"]);
            return a.style.height = M(t.height + t.depth),
        ...
        function et(r, e) {
            ...
            p.classes = ["tag"],
            s.push(p)) : n && s.push(n);
            var g = E0(["katex-html"], s);
            if (g.setAttribute("aria-hidden", "true"),
            p) {
                var y = p.children[0];
                y.style.height = M(g.height + g.depth),
                g.depth && (y.style.verticalAlign = M(-g.depth))
            }
            return g
        }
        function nr(r) {
        ...
        class f0 {
            ...
            toNode() {
                ...
                this.classes.length > 0 && (e.className = q0(this.classes));
                for (var a = 0; a < this.children.length; a++)
            ...
            toMarkup() {
                ...
                for (var t in this.attributes)
                    ...
                    e += '"');
                this.classes.length > 0 && (e += ' class ="' + q.escape(q0(this.classes)) + '"'),
                e += ">";
                for (var a = 0; a < this.children.length; a++)
                    e += this.children[a].toMarkup();
                return e += "</" + this.type + ">",
        ...
        class ga {
            ...
            toNode() {
                ...
                return e.setAttribute("width", M(this.width)),
                e
            }
            toMarkup() {
        ...
        var S = {
          ...
          , p0 = function(e, t, a) {
            return Y[t][e] && Y[t][e].replace && e.charCodeAt(0) !== 55349 && !(Xt.hasOwnProperty(e) && a && (a.fontFamily && a.fontFamily.slice(4, 6) === "tt" || a.font && a.font.slice(4, 6) === "tt")) && (e = Y[t][e].replace),
            new S.TextNode(e)
        }
          , tt = function(e) {
          ...
          , rt = function(e, t) {
            ...
            return Ve(s, u, n) ? b.fontMap[a].variant : null
        }
          , l0 = function(e, t, a) {
            if (e.length === 1) {
                var n = X(e[0], t);
                return a && n instanceof f0 && n.type === "mo" && (n.setAttribute("lspace", "0em"),
                n.setAttribute("rspace", "0em")),
                [n]
            }
            for (var s = [], u, h = 0; h < e.length; h++) {
                var c = X(e[h], t);
                if (c instanceof f0 && u instanceof f0) {
                    if (c.type === "mtext" && u.type === "mtext" && c.getAttribute("mathvariant") === u.getAttribute("mathvariant")) {
                        ...
                        u.children.push(...c.children);
                        continue
                    } else if (c.type === "mi" && c.children.length === 1 && u.type === "mn") {
                        var p = c.children[0];
                        if (p instanceof le && p.text === ".") {
                            u.children.push(...c.children);
                            continue
                        }
                    } else if (u.type === "mi" && u.children.length === 1) {
                        var g = u.children[0];
                        if (g instanceof le && g.text === "\u0338" && (c.type === "mo" || c.type === "mi" || c.type === "mn")) {
                            var y = c.children[0];
                            y instanceof le && y.text.length > 0 && (y.text = y.text.slice(0, 1) + "\u0338" + y.text.slice(1),
                            s.pop())
                        }
                    }
                }
        ...
        function ir(r, e, t, a, n) {
            var s = l0(r, t), u;
            s.length === 1 && s[0]instanceof f0 && q.contains(["mrow", "mtable"], s[0].type) ? u = s[0] : u = new S.MathNode("mrow",s);
            var h = new S.MathNode("annotation",[new S.TextNode(e)]);
            h.setAttribute("encoding", "application/x-tex");
            var c = new S.MathNode("semantics",[u, h])
        ...
        var sr = function(e) {
          ...
          , ba = function(e, t, a) {
            var n = sr(a), s;
            if (a.output === "mathml")
                return ir(e, t, n, a.displayMode, !0);
            if (a.output === "html") {
                var u = et(e, n);
          ...
          , wa = function(e) {
            var t = new S.MathNode("mo",[new S.TextNode(xa[e.replace(/^\\/, "")])]);
          ...
          , Aa = function(e, t) {
            function a() {
                ...
                if (q.contains(["widehat", "widecheck", "widetilde", "utilde"], c)) {
                    ...
                    return {
                        span: b.makeSvgSpan([], [T], t),
                        minWidth: 0,
                        height: x
                    }
                } else {
                    var D = [], R = ka[c], [O,V,H] = R, U = H / 1e3, G = O.length, K, $;
                    if (G === 1) {
                        var N0 = R[3];
                        K = ["hide-tail"],
                        $ = [N0]
                    } else if (G === 2)
                        K = ["halfarrow-left", "halfarrow-right"],
                        $ = ["xMinYMin", "xMaxYMin"];
                    else if (G === 3)
                        K = ["brace-left", "brace-center", "brace-right"],
            ...
            return n.height = u,
            n.style.height = M(u),
            s > 0 && (n.style.minWidth = M(s)),
            n
        }
          , Ma = function(e, t, a, n, s) {
            var u, h = e.height + e.depth + a + n;
            if (/fbox|color|angl/.test(t)) {
                if (u = b.makeSpan(["stretchy", t], [], s),
                t === "fbox") {
                ...
                var p = [];
                /^[bx]cancel$/.test(t) && p.push(new Ye({
                    x1: "0",
                    y1: "0",
                    x2: "100%",
                    y2: "100%",
        ...
        function Ce(r) {
            return r && (r.type === "atom" || K1.hasOwnProperty(r.type)) ? r : null
        }
        var nt = (r,e)=>{
            var t, a, n;
            r && r.type === "supsub" ? (a = L(r.base, "accent"),
            t = a.base,
            r.base = t,
            n = j1(P(r, e)),
            r.base = a) : (a = L(r, "accent"),
            t = a.base);
            var s = P(t, e.havingCrampedStyle())
              , u = a.isShifty && q.isCharacterBox(t)
              , h = 0;
            if (u) {
            ...
            var D = b.makeSpan(["mord", "accent"], [w], e);
            return n ? (n.children[0] = D,
            n.height = Math.max(D.height, n.height),
            n.classes[0] = "mord",
            n) : D
        }
          , ur = (r,e)=>{
            var t = r.isStretchy ? T0.mathMLnode(r.label) : new S.MathNode("mo",[p0(r.label, r.mode)])
              , a = new S.MathNode("mover",[X(r.base, e), t]);
            return a.setAttribute("accent", "true"),
            a
        }
          , za = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(r=>"\\" + r).join("|"));
        C({
            type: "accent",
        ...
        C({
            ...
            htmlBuilder(r, e) {
                ...
                u = b.wrapFragment(P(r.below, a, e), e),
                u.classes.push(s + "-arrow-pad"));
                var h = T0.svgSpan(r, e)
                ...
                var g;
                if (u) {
                    var y = -e.fontMetrics().axisHeight + u.height + .5 * h.height + .111;
                    g = b.makeVList({
        ...
        var Ca = {
          ...
          , cr = r=>r.type === "textord" && r.text === "@"
          , Ea = (r,e)=>(r.type === "mathord" || r.type === "atom") && r.text === e;
        function Ta(r, e, t) {
            var a = Ca[r];
            switch (a) {
            case "\\\\cdrightarrow":
        ...
        function Da(r) {
            ...
            for (var a = [], n = [a], s = 0; s < e.length; s++) {
                for (var u = e[s], h = mr(), c = 0; c < u.length; c++)
                    if (!cr(u[c]))
                        h.body.push(u[c]);
                    else {
                        a.push(h),
                            ...
                            if ("<>AV".indexOf(p) > -1)
                                for (var y = 0; y < 2; y++) {
                                    for (var w = !0, x = c + 1; x < u.length; x++) {
                                        ...
                                        if (cr(u[x]))
                                            throw new A("Missing a " + p + " character to complete a CD arrow.",u[x]);
                                        g[y].body.push(u[x])
                                    }
                                    if (w)
                                        throw new A("Missing a " + p + " character to complete a CD arrow.",u[c])
                                }
                            else
                                throw new A('Expected one of "<>AV=|." after @',u[c]);
                        var z = Ta(p, g, r)
                          , B = {
                            type: "styling",
                            body: [z],
        ...
        C({
            ...
            handler(r, e) {
                for (var {parser: t} = r, a = L(e[0], "ordgroup"), n = a.body, s = "", u = 0; u < n.length; u++) {
                    var h = L(n[u], "textord");
                    s += h.text
                }
                var c = parseInt(s), p;
                if (isNaN(c))
                    throw new A("\\@char has non-numeric argument " + s);
                if (c < 0 || c >= 1114111)
                    throw new A("\\@char with invalid code point " + s);
        ...
        var dr = (r,e)=>{
            var t = e0(r.body, e.withColor(r.color), !1);
            return b.makeFragment(t)
        }
          , fr = (r,e)=>{
            var t = l0(r.body, e.withColor(r.color))
              , a = new S.MathNode("mstyle",t);
        ...
        C({
            ...
            htmlBuilder(r, e) {
                ...
                r.size && (t.style.marginTop = M(j(r.size, e)))),
                t
            },
            mathmlBuilder(r, e) {
                var t = new S.MathNode("mspace");
                return r.newLine && (t.setAttribute("linebreak", "newline"),
                r.size && t.setAttribute("height", M(j(r.size, e)))),
                t
            }
        });
        var it = {
        ...
        C({
            ...
            handler(r) {
                ...
                var a = e.fetch();
                if (it[a.text])
                    return (t === "\\global" || t === "\\\\globallong") && (a.text = it[a.text]),
        ...
        C({
            ...
            handler(r) {
                var {parser: e, funcName: t} = r
                  ...
                  , n = e.gullet.popToken()
                  , s = e.gullet.popToken();
                return vr(e, a, s, t === "\\\\globalfuture"),
        ...
        var ue = function(e, t, a) {
            var n = Y.math[e] && Y.math[e].replace
              , s = Ve(n || e, t, a);
            if (!s)
          ...
          , st = function(e, t, a, n) {
            var s = a.havingBaseStyle(t)
              , u = b.makeSpan(n.concat(s.sizingClasses(a)), [e], a)
          ...
          , br = function(e, t, a, n, s, u) {
            var h = qa(e, t, s, n)
              , c = st(b.makeSpan(["delimsizing", "size" + t], [h], n), N.TEXT, n, u);
            return a && gr(c, n, N.TEXT),
            c
        }
          , lt = function(e, t, a) {
            var n;
          ...
          , ut = function(e, t, a) {
            var n = x0["Size4-Regular"][e.charCodeAt(0)] ? x0["Size4-Regular"][e.charCodeAt(0)][4] : x0["Size1-Regular"][e.charCodeAt(0)][4]
              , s = new R0("inner",P1(e, Math.round(1e3 * t)))
              , u = new z0([s],{
                width: M(n),
                height: M(t),
                style: "width:" + M(n),
          ...
          , yr = function(e, t, a, n, s, u) {
            ...
            p = "\u2016",
            g = "\\Downarrow") : q.contains(Ra, e) ? (p = "\u2223",
            y = "vert",
            w = 333) : q.contains(Ia, e) ? (p = "\u2225",
            y = "doublevert",
            w = 556) : e === "[" || e === "\\lbrack" ? (h = "\u23A1",
            p = "\u23A2",
            g = "\u23A3",
            ...
            var G = B + O + V
              , K = Math.max(0, Math.ceil((t - G) / (H * D)))
              , $ = G + K * H * D
              , N0 = n.fontMetrics().axisHeight;
            a && (N0 *= n.sizeMultiplier);
            var n0 = $ / 2 - N0
              , t0 = [];
            if (y.length > 0) {
                var Y0 = $ - B - O
                  , u0 = Math.round($ * 1e3)
                  , b0 = G1(y, Math.round(Y0 * 1e3))
                  , P0 = new R0(y,b0)
                  , Q0 = (w / 1e3).toFixed(3) + "em"
                  , _0 = (u0 / 1e3).toFixed(3) + "em"
                  , Ct = new z0([P0],{
                    width: Q0,
                    height: _0,
                    viewBox: "0 0 " + w + " " + u0
                })
                  , G0 = b.makeSvgSpan([], [Ct], n);
                G0.height = u0 / 1e3,
                G0.style.width = Q0,
                G0.style.height = _0,
                t0.push({
            ...
            var ce = n.havingBaseStyle(N.TEXT)
              , Et = b.makeVList({
                positionType: "bottom",
                positionData: n0,
                children: t0
            }, ce);
            return st(b.makeSpan(["delimsizing", "mult"], [Et], ce), N.TEXT, n, u)
        }
          , ht = 80
          , mt = .08
          , ct = function(e, t, a, n, s) {
            var u = H1(e, n, a)
              , h = new R0(e,u)
              , c = new z0([h],{
                width: "400em",
          ...
          , Oa = function(e, t) {
            var a = t.havingBaseSizing(), n = Sr("\\surd", e * a.sizeMultiplier, kr, a), s = a.sizeMultiplier, u = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), h, c = 0, p = 0, g = 0, y;
            return n.type === "small" ? (g = 1e3 + 1e3 * u + ht,
            e < 1 ? s = 1 : e < 1.4 && (s = .7),
            c = (1 + u + mt) / s,
            p = (1 + u) / s,
            h = ct("sqrtMain", c, g, u, t),
            h.style.minWidth = "0.853em",
            y = .833 / s) : n.type === "large" ? (g = (1e3 + ht) * oe[n.size],
            p = (oe[n.size] + u) / s,
            c = (oe[n.size] + u + mt) / s,
            h = ct("sqrtSize" + n.size, c, g, u, t),
            h.style.minWidth = "1.02em",
            y = 1 / s) : (c = e + u + mt,
            p = e + u,
            g = Math.floor(1e3 * e + u) + ht,
            h = ct("sqrtTall", c, g, u, t),
          ...
          , La = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27EE", "\u27EF", "\\lmoustache", "\\rmoustache", "\u23B0", "\u23B1"]
          , wr = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"]
          , oe = [0, 1.2, 1.8, 2.4, 3]
          , Ha = function(e, t, a, n, s) {
            if (e === "<" || e === "\\lt" || e === "\u27E8" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "\u27E9") && (e = "\\rangle"),
            q.contains(xr, e) || q.contains(wr, e))
                return br(e, t, !1, a, n, s);
            if (q.contains(La, e))
                return yr(e, oe[t], !1, a, n, s);
          ...
          , Ar = function(e, t, a, n, s, u) {
            e === "<" || e === "\\lt" || e === "\u27E8" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "\u27E9") && (e = "\\rangle");
            var h;
            q.contains(wr, e) ? h = Pa : q.contains(xr, e) ? h = kr : h = Ga;
            var c = Sr(e, t, h, n);
            return c.type === "small" ? Fa(e, c.style, a, n, s, u) : c.type === "large" ? br(e, c.size, a, n, s, u) : yr(e, t, a, n, s, u)
        }
          , Ua = function(e, t, a, n, s, u) {
            var h = n.fontMetrics().axisHeight * n.sizeMultiplier
              , c = 901
              , p = 5 / n.fontMetrics().ptPerEm
              , g = Math.max(t - h, a + h)
              , y = Math.max(g / 500 * c, 2 * g - p);
            return Ar(e, y, !0, n, s, u)
        }
          , D0 = {
            sqrtImage: Oa,
            sizedDelim: Ha,
          ...
          , $a = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "\u230A", "\u230B", "\\lceil", "\\rceil", "\u2308", "\u2309", "<", ">", "\\langle", "\u27E8", "\\rangle", "\u27E9", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27EE", "\u27EF", "\\lmoustache", "\\rmoustache", "\u23B0", "\u23B1", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
        function Ne(r, e) {
            var t = Ce(r);
            if (t && q.contains($a, t.text))
                return t;
        ...
        C({
            ...
            mathmlBuilder: r=>{
                ...
                var a = M(D0.sizeToMaxHeight[r.size]);
        ...
        C({
            ...
            htmlBuilder: (r,e)=>{
                zr(r);
                for (var t = e0(r.body, e, !0, ["mopen", "mclose"]), a = 0, n = 0, s = !1, u = 0; u < t.length; u++)
                    t[u].isMiddle ? s = !0 : (a = Math.max(t[u].height, a),
                    n = Math.max(t[u].depth, n));
                a *= e.sizeMultiplier,
                n *= e.sizeMultiplier;
                var h;
                if (r.left === "." ? h = se(e, ["mopen"]) : h = D0.leftRightDelim(r.left, a, n, e, r.mode, ["mopen"]),
                t.unshift(h),
                s)
        ...
        var dt = (r,e)=>{
            ...
            if (a === "sout")
                ...
                t.style.paddingLeft = M(y / 2 + c);
                var w = Math.floor(1e3 * y * n)
                  , x = O1(w)
                  , z = new z0([new R0("phase",x)],{
                    width: "400em",
                    height: M(w / 1e3),
                ...
                var B = 0
                  , T = 0
                  , D = 0;
                /box/.test(a) ? (D = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness),
                B = e.fontMetrics().fboxsep + (a === "colorbox" ? 0 : D),
                T = B) : a === "angl" ? (D = Math.max(e.fontMetrics().defaultRuleThickness, e.minRuleThickness),
                B = 4 * D,
                T = Math.max(0, .25 - t.depth)) : (B = h ? .2 : 0,
                T = B),
                s = T0.encloseSpan(t, a, B, T, e),
                /fbox|boxed|fcolorbox/.test(a) ? (s.style.borderStyle = "solid",
                s.style.borderWidth = M(D)) : a === "angl" && D !== .049 && (s.style.borderTopWidth = M(D),
                s.style.borderRightWidth = M(D)),
                u = t.depth + T,
            ...
            return /cancel/.test(a) && (R.height = t.height,
            R.depth = t.depth),
            /cancel/.test(a) && !h ? b.makeSpan(["mord", "cancel-lap"], [R], e) : b.makeSpan(["mord"], [R], e)
        }
          , ft = (r,e)=>{
            var t = 0
        ...
        function L0(r, e, t) {
            var {hskipBeforeAndAfter: a, addJot: n, cols: s, arraystretch: u, colSeparationType: h, autoTag: c, singleRow: p, emptySingleRow: g, maxNumCols: y, leqno: w} = e;
            ...
            !u) {
                ...
                if (x == null)
                    u = 1;
                else if (u = parseFloat(x),
                !u || u < 0)
                    throw new A("Invalid \\arraystretch: " + x)
            }
            r.gullet.beginGroup();
            var z = []
              , B = [z]
            ...
            function V() {
                R && (r.gullet.macros.get("\\df@tag") ? (R.push(r.subparse([new m0("\\df@tag")])),
                r.gullet.macros.set("\\df@tag", void 0, !0)) : R.push(Boolean(c) && r.gullet.macros.get("\\@eqnsw") === "1"))
            }
            for (O(),
            D.push(Er(r)); ; ) {
                ...
                if (U === "&") {
                    ...
                    V(),
                    z.length === 1 && H.type === "styling" && H.body[0].body.length === 0 && (B.length > 1 || !g) && B.pop(),
                    D.length < B.length + 1 && D.push([]);
                    break
                } else if (U === "\\\\") {
                    r.consume();
                    var G = void 0;
                    r.gullet.future().text !== " " && (G = r.parseSizeGroup(!0)),
                    T.push(G ? G.value : null),
                    V(),
                    D.push(Er(r)),
                    z = [],
                    B.push(z),
        ...
        var k0 = function(e, t) {
            var a, n, s = e.body.length, u = e.hLinesBeforeRow, h = 0, c = new Array(s), p = [], g = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness), y = 1 / t.fontMetrics().ptPerEm, w = 5 * y;
            if (e.colSeparationType && e.colSeparationType === "small") {
                var x = t.havingStyle(N.SCRIPT).sizeMultiplier;
                w = .2778 * (x / t.sizeMultiplier)
            }
            var z = e.colSeparationType === "CD" ? j({
                number: 3,
                unit: "ex"
            }, t) : 12 * y
              , B = 3 * y
            ...
            var t0 = O / 2 + t.fontMetrics().axisHeight, Y0 = e.cols || [], u0 = [], b0, P0, Q0 = [];
            if (e.tags && e.tags.some(Oe=>Oe))
                for (a = 0; a < s; ++a) {
                    var _0 = c[a]
                      , Ct = _0.pos - t0
                      , G0 = e.tags[a]
                      , V0 = void 0;
                    G0 === !0 ? V0 = b.makeSpan(["eqn-num"], [], t) : G0 === !1 ? V0 = b.makeSpan([], [], t) : V0 = b.makeSpan([], e0(G0, t, !0), t),
                    V0.depth = _0.depth,
                    V0.height = _0.height,
                    Q0.push({
                        type: "elem",
            ...
            for (n = 0,
            P0 = 0; n < h || P0 < Y0.length; ++n,
            ++P0) {
                for (var v0 = Y0[P0] || {}, ce = !0; v0.type === "separator"; ) {
                    if (ce || (b0 = b.makeSpan(["arraycolsep"], []),
                    b0.style.width = M(t.fontMetrics().doubleRuleSep),
                    u0.push(b0)),
                    v0.separator === "|" || v0.separator === ":") {
                        var Et = v0.separator === "|" ? "solid" : "dashed"
                          , ee = b.makeSpan(["vertical-separator"], [], t);
                        ee.style.height = M(O),
                        ee.style.borderRightWidth = M(g),
                        ee.style.borderRightStyle = Et,
                        ee.style.margin = "0 " + M(-g / 2);
                        var m1 = O - t0;
                        m1 && (ee.style.verticalAlign = M(-m1)),
                        u0.push(ee)
                    } else
                        throw new A("Invalid separator type: " + v0.separator);
                    P0++,
                    v0 = Y0[P0] || {},
                    ce = !1
                }
                if (!(n >= h)) {
                    var te = void 0;
                    (n > 0 || e.hskipBeforeAndAfter) && (te = q.deflt(v0.pregap, w),
                    te !== 0 && (b0 = b.makeSpan(["arraycolsep"], []),
                    b0.style.width = M(te),
                    u0.push(b0)));
                    var re = [];
                    for (a = 0; a < s; ++a) {
                    ...
                    re = b.makeSpan(["col-align-" + (v0.align || "c")], [re]),
                    u0.push(re),
                    (n < h - 1 || e.hskipBeforeAndAfter) && (te = q.deflt(v0.postgap, w),
                    te !== 0 && (b0 = b.makeSpan(["arraycolsep"], []),
                    b0.style.width = M(te),
                    u0.push(b0)))
                }
            }
            if (c = b.makeSpan(["mtable"], u0),
            p.length > 0) {
                for (var b4 = b.makeLineSpan("hline", t, g), y4 = b.makeLineSpan("hdashline", t, g), Tt = [{
                    type: "elem",
                    elem: c,
                    shift: 0
                }]; p.length > 0; ) {
          ...
          , S0 = function(e, t) {
            ...
            if (e.cols && e.cols.length > 0) {
                ...
                R -= 1);
                for (var O = D; O < R; O++)
                    z[O].type === "align" ? (x += Xa[z[O].align],
                    T && (B += "none "),
                    T = !0) : z[O].type === "separator" && T && (B += z[O].separator === "|" ? "solid " : "dashed ",
                    T = !1);
                g.setAttribute("columnalign", x.trim()),
                /[sd]/.test(B) && g.setAttribute("columnlines", B.trim())
            }
            ...
            var G = ""
              , K = e.hLinesBeforeRow;
            w += K[0].length > 0 ? "left " : "",
            w += K[K.length - 1].length > 0 ? "right " : "";
            for (var $ = 1; $ < K.length - 1; $++)
                G += K[$].length === 0 ? "none " : K[$][0] ? "dashed " : "solid ";
          ...
          , Tr = function(e, t) {
            ...
            var a = [], n = e.envName.indexOf("at") > -1 ? "alignat" : "align", s = e.envName === "split", u = L0(e.parser, {
                cols: a,
                addJot: !0,
                autoTag: s ? void 0 : pt(e.envName),
                emptySingleRow: !0,
                colSeparationType: n,
            ...
            var x = !c;
            u.body.forEach(function(D) {
                for (var R = 1; R < D.length; R += 2) {
                    var O = L(D[R], "styling")
                      , V = L(O.body[0], "ordgroup");
                    V.body.unshift(p)
                }
                if (x)
                    ...
                    var H = D.length / 2;
                    if (h < H)
                        throw new A("Too many math in a row: " + ("expected " + h + ", but got " + H),D[0])
                }
            });
            for (var z = 0; z < c; ++z) {
                var B = "r"
            ...
            return u.colSeparationType = x ? "align" : "alignat",
            u
        };
        w0({
            type: "array",
            ...
            handler(r, e) {
                var t = Ce(e[0])
                  ...
                  , n = a.map(function(u) {
                    ...
                    throw new A("Unknown column alignment: " + c,u)
                })
                  , s = {
                    cols: n,
                ...
                return L0(r.parser, s, vt(r.envName))
            },
            htmlBuilder: k0,
            mathmlBuilder: S0
        }),
        w0({
            ...
            handler(r) {
                ...
                var s = L0(r.parser, a, vt(r.envName))
        ...
        C({
            ...
            handler(r, e) {
                var {parser: t, funcName: a} = r
                  , n = e[0];
                if (n.type !== "ordgroup")
                    throw new A("Invalid environment name",n);
                for (var s = "", u = 0; u < n.body.length; ++u)
                    s += L(n.body[u], "textord").text;
                if (a === "\\begin") {
                    if (!Dr.hasOwnProperty(s))
                        throw new A("No such environment: " + s,n);
                    var h = Dr[s]
                    ...
                    if (x.name !== s)
                        throw new A("Mismatch: \\begin{" + s + "} matched by \\end{" + x.name + "}",w);
                    return y
                }
                return {
                    type: "environment",
        ...
        var Rr = (r,e)=>{
            var t = e;
            return r === "display" ? t = t.id >= N.SCRIPT.id ? t.text() : N.DISPLAY : r === "text" && t.size === N.DISPLAY.size ? t = N.TEXT : r === "script" ? t = N.SCRIPT : r === "scriptscript" && (t = N.SCRIPTSCRIPT),
            t
        }
          , gt = (r,e)=>{
            var t = Rr(r.size, e.style), a = t.fracNum(), n = t.fracDen(), s;
            s = e.havingStyle(a);
            var u = P(r.numer, s, e);
            if (r.continued) {
                var h = 8.5 / e.fontMetrics().ptPerEm
                  , c = 3.5 / e.fontMetrics().ptPerEm;
                u.height = u.height < h ? h : u.height,
                u.depth = u.depth < c ? c : u.depth
            }
            s = e.havingStyle(n);
            var p = P(r.denom, s, e), g, y, w;
            r.hasBarLine ? (r.barSize ? (y = j(r.barSize, e),
            ...
            var x, z, B;
            t.size === N.DISPLAY.size || r.size === "display" ? (x = e.fontMetrics().num1,
            y > 0 ? z = 3 * w : z = 7 * w,
            B = e.fontMetrics().denom1) : (y > 0 ? (x = e.fontMetrics().num2,
            z = w) : (x = e.fontMetrics().num3,
            z = 3 * w),
            B = e.fontMetrics().denom2);
            var T;
            if (g) {
                var R = e.fontMetrics().axisHeight;
                x - u.depth - (R + .5 * y) < z && (x += z - (x - u.depth - (R + .5 * y))),
                R - .5 * y - (p.height - B) < z && (B += z - (R - .5 * y - (p.height - B)));
                var O = -(R - .5 * y);
                T = b.makeVList({
                    positionType: "individualShift",
                    children: [{
            ...
            s = e.havingStyle(t),
            T.height *= s.sizeMultiplier / e.sizeMultiplier,
            T.depth *= s.sizeMultiplier / e.sizeMultiplier;
            var V;
            ...
            var H, U;
            return r.leftDelim == null ? H = se(e, ["mopen"]) : H = D0.customSizedDelim(r.leftDelim, V, !0, e.havingStyle(t), r.mode, ["mopen"]),
            r.continued ? U = b.makeSpan([]) : r.rightDelim == null ? U = se(e, ["mclose"]) : U = D0.customSizedDelim(r.rightDelim, V, !0, e.havingStyle(t), r.mode, ["mclose"]),
            b.makeSpan(["mord"].concat(s.sizingClasses(e)), [H, b.makeSpan(["mfrac"], [T]), U], e)
        }
          , bt = (r,e)=>{
            ...
            var n = Rr(r.size, e.style);
            if (n.size !== e.style.size) {
                t = new S.MathNode("mstyle",[t]);
                var s = n.size === N.DISPLAY.size ? "true" : "false";
        ...
        C({
            ...
            handler: (r,e)=>{
                var {parser: t, funcName: a} = r, n = e[0], s = e[1], u, h = null, c = null, p = "auto";
                switch (a) {
                case "\\dfrac":
                case "\\frac":
                case "\\tfrac":
        ...
        C({
            ...
            handler(r, e) {
                var {parser: t} = r, a = e[4], n = e[5], s = ze(e[0]), u = s.type === "atom" && s.family === "open" ? Or(s.text) : null, h = ze(e[1]), c = h.type === "atom" && h.family === "close" ? Or(h.text) : null, p = L(e[2], "size"), g, y = null;
        ...
        var Lr = (r,e)=>{
            ...
            n = L(r.base, "horizBrace")) : n = L(r, "horizBrace");
            var s = P(n.base, e.havingBaseStyle(N.DISPLAY)), u = T0.svgSpan(n, e), h;
        ...
        C({
            ...
            mathmlBuilder: (r,e)=>{
                var t = O0(r.body, e);
                return t instanceof f0 || (t = new f0("mrow",[t])),
        ...
        C({
            ...
            mathmlBuilder(r, e) {
                return new S.MathNode("mrow",l0(r.body, e))
            }
        }),
        C({
            type: "html",
        ...
        C({
            ...
            ,
            mathmlBuilder: (r,e)=>O0(r.mathml, e)
        });
        var yt = function(e) {
            if (/^[-+]? *(\d+(\.\d*)?|\.\d+)$/.test(e))
                return {
        ...
        C({
                    ...
                    for (var c = L(t[0], "raw").string, p = c.split(","), g = 0; g < p.length; g++) {
                        ...
                        if (y.length === 2) {
                            ...
                            case "totalheight":
                                ...
                                break;
                            default:
                                throw new A("Invalid key: '" + y[0] + "' in \\includegraphics.")
                            }
                        }
                    }
                var x = L(e[0], "url").url;
            ...
            htmlBuilder: (r,e)=>{
                ...
                n > 0 && (s.width = M(n)),
                a > 0 && (s.verticalAlign = M(-a));
                var u = new Y1(r.src,r.alt,s);
                return u.height = t,
                u.depth = a,
                u
            }
            ...
            mathmlBuilder: (r,e)=>{
                ...
                var a = j(r.height, e)
                  , n = 0;
                if (r.totalheight.number > 0 && (n = j(r.totalheight, e) - a,
                t.setAttribute("valign", M(-n))),
                t.setAttribute("height", M(a + n)),
                r.width.number > 0) {
                    var s = j(r.width, e);
                    t.setAttribute("width", M(s))
                }
        ...
        C({
            ...
            handler(r, e) {
                ...
                if (t.settings.strict) {
                    var s = a[1] === "m"
                      , u = n.value.unit === "mu";
                    s ? (u || t.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " supports only mu units, " + ("not " + n.value.unit + " units")),
                    t.mode !== "math" && t.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " works only in math mode")) : u && t.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " doesn't support mu units")
                }
                return {
                    type: "kern",
                    mode: t.mode,
        ...
        C({
            ...
            htmlBuilder: (r,e)=>{
                ...
                var a = b.makeSpan(["fix"], [])
                  ...
                  , s = b.makeSpan(["strut"]);
                return s.style.height = M(n.height + n.depth),
                n.depth && (s.style.verticalAlign = M(-n.depth)),
        ...
        var Pr = (r,e,t,a,n,s,u)=>{
            ...
            var T = [w];
            if (c && s !== 0 && !h) {
                var D = b.makeSpan(["mspace"], [], a);
                D.style.marginRight = M(s),
                T.unshift(D)
            }
            return b.makeSpan(["mop", "op-limits"], T, a)
        }
          , Gr = ["\\smallint"]
          , J0 = (r,e)=>{
            var t, a, n = !1, s;
            ...
            var u = e.style
              , h = !1;
            u.size === N.DISPLAY.size && s.symbol && !q.contains(Gr, s.name) && (h = !0);
            var c;
            if (s.symbol) {
                ...
                var x = e0(s.body, e, !0);
                x.length === 1 && x[0]instanceof d0 ? (c = x[0],
                c.classes[0] = "mop") : c = b.makeSpan(["mop"], x, e)
            } else {
                for (var z = [], B = 1; B < s.name.length; B++)
                    z.push(b.mathsym(s.name[B], s.mode, e));
                c = b.makeSpan(["mop"], z, e)
            }
            var T = 0
              , D = 0;
            return (c instanceof d0 || s.name === "\\oiint" || s.name === "\\oiiint") && !s.suppressBaseShift && (T = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight,
            D = c.italic),
            n ? Pr(c, t, a, e, u, D, T) : (T && (c.style.position = "relative",
            c.style.top = M(T)),
            c)
        }
          , he = (r,e)=>{
            var t;
            if (r.symbol)
                t = new f0("mo",[p0(r.name, r.mode)]),
                q.contains(Gr, r.name) && t.setAttribute("largeop", "false");
            else if (r.body)
                t = new f0("mo",l0(r.body, e));
            else {
                t = new f0("mi",[new le(r.name.slice(1))]);
                var a = new f0("mo",[p0("\u2061", "text")]);
                r.parentIsSupSub ? t = new f0("mrow",[t, a]) : t = nr([t, a])
            }
            return t
        }
          , Wa = {
        ...
        var Vr = (r,e)=>{
            ...
            r.type === "supsub" ? (t = r.sup,
            a = r.sub,
            s = L(r.base, "operatorname"),
            n = !0) : s = L(r, "operatorname");
            var u;
            if (s.body.length > 0) {
                ...
                ), c = e0(h, e.withFont("mathrm"), !0), p = 0; p < c.length; p++) {
                    var g = c[p];
                ...
                u = b.makeSpan(["mop"], [], e);
            return n ? Pr(u, t, a, e, e.style, 0, 0) : u
        }
          , Za = (r,e)=>{
            for (var t = l0(r.body, e.withFont("mathrm")), a = !0, n = 0; n < t.length; n++) {
                var s = t[n];
        ...
        X0({
            type: "ordgroup",
            htmlBuilder(r, e) {
                return r.semisimple ? b.makeFragment(e0(r.body, e, !1)) : b.makeSpan(["mord"], e0(r.body, e, !0), e)
            },
            mathmlBuilder(r, e) {
                return O0(r.body, e, !0)
            }
        }),
        C({
            type: "overline",
        ...
        C({
            ...
            ,
            htmlBuilder: (r,e)=>{
                var t = e0(r.body, e.withPhantom(), !1);
                return b.makeFragment(t)
            }
            ,
            mathmlBuilder: (r,e)=>{
        ...
        C({
            ...
            htmlBuilder(r, e) {
                ...
                return t.style.borderRightWidth = M(a),
            ...
            mathmlBuilder(r, e) {
                var t = j(r.width, e)
                  ...
                  , u = new S.MathNode("mspace");
                u.setAttribute("mathbackground", s),
                u.setAttribute("width", M(t)),
                u.setAttribute("height", M(a));
                var h = new S.MathNode("mpadded",[u]);
                return n >= 0 ? h.setAttribute("height", M(n)) : (h.setAttribute("height", M(n)),
                h.setAttribute("depth", M(-n))),
                h.setAttribute("voffset", M(n)),
                h
            }
        });
        function Ur(r, e, t) {
            for (var a = e0(r, e, !1), n = e.sizeMultiplier / t.sizeMultiplier, s = 0; s < a.length; s++) {
                var u = a[s].classes.indexOf("sizing");
                u < 0 ? Array.prototype.push.apply(a[s].classes, e.sizingClasses(t)) : a[s].classes[u + 1] === "reset-size" + e.size && (a[s].classes[u + 1] = "reset-size" + t.size),
                a[s].height *= n,
                a[s].depth *= n
            }
            return b.makeFragment(a)
        ...
        C({
            ...
            mathmlBuilder: (r,e)=>{
                ...
                return n.setAttribute("mathsize", M(t.sizeMultiplier)),
                n
            }
        }),
        C({
            ...
            htmlBuilder(r, e) {
                ...
                if (r.index) {
                    var z = e.havingStyle(N.SCRIPTSCRIPT)
                      ...
                      , R = b.makeSpan(["root"], [D]);
                    return b.makeSpan(["mord", "sqrt"], [R, x], e)
                } else
        ...
        var Ja = function(e, t) {
            ...
            if (a)
                if (a.type === "op") {
                    ...
                    if (a.type === "accent")
                        return q.isCharacterBox(a.base) ? nt : null;
                    if (a.type === "horizBrace") {
                        var u = !e.sub;
                        return u === a.isOver ? Lr : null
                    } else
                        return null
                }
            else
        ...
        X0({
            ...
            htmlBuilder(r, e) {
                ...
                if (t)
                    return t(r, e);
                var {base: a, sup: n, sub: s} = r, u = P(a, e), h, c, p = e.fontMetrics(), g = 0, y = 0, w = a && q.isCharacterBox(a);
                if (n) {
                    var x = e.havingStyle(e.style.sup());
                    h = P(n, x, e),
                    w || (g = u.height - x.fontMetrics().supDrop * x.sizeMultiplier / e.sizeMultiplier)
                }
                if (s) {
                    var z = e.havingStyle(e.style.sub());
                    c = P(s, z, e),
                    w || (y = u.depth + z.fontMetrics().subDrop * z.sizeMultiplier / e.sizeMultiplier)
                }
                var B;
                e.style === N.DISPLAY ? B = p.sup1 : e.style.cramped ? B = p.sup3 : B = p.sup2;
                var T = e.sizeMultiplier
                  , D = M(.5 / p.ptPerEm / T)
                  , R = null;
                if (c) {
                    var O = r.base && r.base.type === "op" && r.base.name && (r.base.name === "\\oiint" || r.base.name === "\\oiiint");
                    (u instanceof d0 || O) && (R = M(-u.italic))
                }
                var V;
                if (h && c) {
                    g = Math.max(g, B, h.depth + .25 * p.xHeight),
                    y = Math.max(y, p.sub2);
                ...
                var N0 = _e(u, "right") || "mord";
                return b.makeSpan([N0], [u, b.makeSpan(["msupsub"], [V])], e)
            },
            mathmlBuilder(r, e) {
                var t = !1, a, n;
        ...
        X0({
            ...
            mathmlBuilder(r, e) {
                var t = new S.MathNode("mi",[p0(r.text, r.mode, e)])
                  , a = rt(r, e) || "italic";
                return a !== Yr[t.type] && t.setAttribute("mathvariant", a),
                t
            }
        }),
        X0({
            ...
            mathmlBuilder(r, e) {
                var t = p0(r.text, r.mode, e), a = rt(r, e) || "normal", n;
                ...
                a !== Yr[n.type] && n.setAttribute("mathvariant", a),
                n
            }
        });
        var xt = {
        ...
        X0({
            ...
            htmlBuilder(r, e) {
                if (wt.hasOwnProperty(r.text)) {
                    ...
                    if (xt.hasOwnProperty(r.text))
                        return b.makeSpan(["mspace", xt[r.text]], [], e);
        ...
        X0({
            type: "tag",
            mathmlBuilder(r, e) {
                var t = new S.MathNode("mtable",[new S.MathNode("mtr",[Wr(), new S.MathNode("mtd",[O0(r.body, e)]), Wr(), new S.MathNode("mtd",[O0(r.tag, e)])])]);
        ...
        var jr = {
          ...
          , Kr = (r,e)=>{
            var t = r.font;
            return t ? jr[t] ? e.withTextFontFamily(jr[t]) : Zr[t] ? e.withTextFontWeight(Zr[t]) : e.withTextFontShape(Qa[t]) : e
        }
        ;
        C({
            type: "text",
...
?)[ \r	]*`
          , kt = "[\u0300-\u036F]"
          , a4 = new RegExp(kt + "+$")
          , n4 = "(" + Qr + "+)|" + (r4 + "|") + "([!-\\[\\]-\u2027\u202A-\uD7FF\uF900-\uFFFF]" + (kt + "*") + "|[\uD800-\uDBFF][\uDC00-\uDFFF]" + (kt + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + t4) + ("|" + e4 + ")");
        class _r {
            constructor(e, t) {
                this.input = void 0,
                ...
                this.input = e,
                this.settings = t,
                this.tokenRegex = new RegExp(n4,"g"),
                this.catcodes = {
                    "%": 14,
                    "~": 13
                }
            ...
            lex() {
                ...
                if (a === null || a.index !== t)
                    throw new A("Unexpected character: '" + e[t] + "'",new m0(e[t],new o0(this,t,t + 1)));
                var n = a[6] || a[3] || (a[2] ? "\\ " : " ");
...
`, this.tokenRegex.lastIndex);
        ...
        m("\\char", function(r) {
            ...
            if (t) {
                ...
                for (var n; (n = e1[r.future().text]) != null && n < t; )
                    a *= t,
                    a += n,
                    r.popToken()
            }
        ...
        var St = (r,e,t)=>{
            ...
            if (!s && !t)
                throw new A("\\renewcommand{" + n + "} when command " + n + " does not yet exist; use \\newcommand");
            var u = 0;
            if (a = r.consumeArg().tokens,
            a.length === 1 && a[0].text === "[") {
                for (var h = "", c = r.expandNextToken(); c.text !== "]" && c.text !== "EOF"; )
                    h += c.text,
                    c = r.expandNextToken();
                if (!h.match(/^\s*[0-9]+\s*$/))
                    throw new A("Invalid number of arguments: " + h);
                u = parseInt(h),
                a = r.consumeArg().tokens
            }
        ...
        ;
        m("\\newcommand", r=>St(r, !1, !0)),
        m("\\renewcommand", r=>St(r, !0, !1)),
        m("\\providecommand", r=>St(r, !0, !0)),
        m("\\message", r=>{
        ...
        m("\\dots", function(r) {
            ...
            return t in t1 ? e = t1[t] : (t.slice(0, 4) === "\\not" || t in Y.math && q.contains(["bin", "rel"], Y.math[t].group)) && (e = "\\dotsb"),
            e
        });
        var At = {
            ")": !0,
        ...
        m("\\dotso", function(r) {
            var e = r.future().text;
            return e in At ? "\\ldots\\," : "\\ldots"
        }),
        m("\\dotsc", function(r) {
            var e = r.future().text;
            return e in At && e !== "," ? "\\ldots\\," : "\\ldots"
        }),
        m("\\cdots", function(r) {
            var e = r.future().text;
            return e in At ? "\\@cdots\\," : "\\@cdots"
        }),
        m("\\dotsb", "\\cdots"),
        m("\\dotsm", "\\cdots"),
        m("\\dotsi", "\\!\\cdots"),
        ...
        var r1 = M(x0["Main-Regular"]["T".charCodeAt(0)][1] - .7 * x0["Main-Regular"]["A".charCodeAt(0)][1]);
        m("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + r1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}"),
        m("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + r1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}"),
        ...
        class l4 {
            constructor(e, t, a) {
                ...
                this.feed(e),
                this.macros = new i4(s4,t.macros),
                this.mode = a,
                this.stack = []
            }
            feed(e) {
                this.lexer = new _r(e,this.settings)
            }
            switchMode(e) {
                this.mode = e
            }
            ...
            scanArgument(e) {
                ...
                return this.pushToken(new m0("EOF",a.loc)),
                this.pushTokens(n),
                t.range(a, "")
            }
            consumeSpaces() {
            ...
            consumeArg(e) {
                ...
                do {
                    ...
                    s.text === "{")
                        ...
                        throw new A("Unexpected end of input in a macro argument, expected '" + (e && a ? e[h] : "}") + "'",s);
                    if (e && a)
            ...
            consumeArgs(e, t) {
                if (t) {
                    ...
                    for (var a = t[0], n = 0; n < a.length; n++) {
                        var s = this.popToken();
                        if (a[n] !== s.text)
                            throw new A("Use of the macro doesn't match its definition",s)
                    }
                }
                for (var u = [], h = 0; h < e; h++)
            ...
            expandOnce(e) {
                ...
                if (n.numArgs) {
                    ...
                    for (var h = s.length - 1; h >= 0; --h) {
                        ...
                        if (c.text === "#") {
                            if (h === 0)
                                throw new A("Incomplete placeholder at end of macro body",c);
                            if (c = s[--h],
                            c.text === "#")
                                s.splice(h + 1, 1);
                                ...
                                throw new A("Not a valid argument number",c)
                        }
                    }
                }
            ...
            expandTokens(e) {
                ...
                for (this.pushTokens(e); this.stack.length > a; ) {
                    ...
                    n instanceof m0 && (n.treatAsRelax && (n.noexpand = !1,
                    n.treatAsRelax = !1),
                ...
                if (typeof n == "string") {
                    ...
                    if (n.indexOf("#") !== -1)
                        for (var u = n.replace(/##/g, ""); u.indexOf("#" + (s + 1)) !== -1; )
                            ++s;
                    for (var h = new _r(n,this.settings), c = [], p = h.lex(); p.text !== "EOF"; )
                        c.push(p),
                        p = h.lex();
                    c.reverse();
                    var g = {
            ...
            isDefined(e) {
                return this.macros.has(e) || H0.hasOwnProperty(e) || Y.math.hasOwnProperty(e) || Y.text.hasOwnProperty(e) || n1.hasOwnProperty(e)
            }
            isExpandable(e) {
                var t = this.macros.get(e);
        ...
        class me {
            constructor(e, t) {
                ...
                this.mode = "math",
                this.gullet = new l4(e,t,this.mode),
                this.settings = t,
            ...
            parseExpression(e, t) {
                for (var a = []; ; ) {
                    ...
                    var n = this.fetch();
                    if (me.endOfExpression.indexOf(n.text) !== -1 || t && n.text === t || e && H0[n.text] && H0[n.text].infix)
                        break;
            ...
            handleInfixNodes(e) {
                for (var t = -1, a, n = 0; n < e.length; n++)
                    if (e[n].type === "infix") {
                        if (t !== -1)
                            throw new A("only one infix operator per group",e[n].token);
                        t = n,
                        a = e[n].replaceWith
                    }
                if (t !== -1 && a) {
                    ...
                    var p;
                    return a === "\\\\abovefrac" ? p = this.callFunction(a, [s, e[t], u], []) : p = this.callFunction(a, [s, u], []),
                    [p]
                } else
                    return e
            }
                ...
                for (var a, n; ; ) {
                    ...
                    if (s.text === "\\limits" || s.text === "\\nolimits") {
                        if (t && t.type === "op") {
                            ...
                            throw new A("Limit controls must follow a math operator",s);
                        this.consume()
                    } else if (s.text === "^") {
                        if (a)
                            throw new A("Double superscript",s);
                        a = this.handleSupSubscript("superscript")
                    } else if (s.text === "_") {
                        if (n)
                            throw new A("Double subscript",s);
                        ...
                        var w = new me(p,this.settings).parse();
                        g ? n = {
                            type: "ordgroup",
                            mode: "math",
                            body: w
            ...
            parseSizeGroup(e) {
                ...
                if (!Pt(s))
                    throw new A("Invalid unit: '" + s.unit + "'",t);
                return {
                    type: "size",
                    mode: this.mode,
                    value: s,
            ...
            parseGroup(e, t) {
                ...
                s == null && n[0] === "\\" && !n1.hasOwnProperty(n)) {
                    if (this.settings.throwOnError)
                        throw new A("Undefined control sequence: " + n,a);
            ...
            parseSymbol() {
                ...
                s1.hasOwnProperty(t[0]) && !Y[this.mode][t[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e),
                t = s1[t[0]] + t.slice(1));
                var s = a4.exec(t);
                ...
                var u;
                if (Y[this.mode][t]) {
                    this.settings.strict && this.mode === "math" && Ke.indexOf(t) >= 0 && this.settings.reportNonstrict("unicodeTextInMathMode", 'Latin-1/Unicode text character "' + t[0] + '" used in math mode', e);
                    var h = Y[this.mode][t].group, c = o0.range(e), p;
                    if (Z1.hasOwnProperty(h)) {
                        var g = h;
                        p = {
                            type: "atom",
                            mode: this.mode,
                    ...
                    this.settings.strict && (Rt(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '"' + (" (" + t.charCodeAt(0) + ")"), e)),
                    u = {
                        type: "textord",
                        mode: "text",
                        loc: o0.range(e),
                ...
                s)
                    for (var y = 0; y < s[0].length; y++) {
                        var w = s[0][y];
                        if (!Mt[w])
                            throw new A("Unknown accent ' " + w + "'",e);
                        var x = Mt[w][this.mode] || Mt[w].text;
                        if (!x)
                            throw new A("Accent " + w + " unsupported in " + this.mode + " mode",e);
                        u = {
                            type: "accent",
                            mode: this.mode,
                            loc: o0.range(e),
        ...
        me.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"];
        var zt = function(e, t) {
        ...
        var u4 = function(e, t) {
          ...
          , u1 = function(e, t, a) {
            if (a.throwOnError || !(e instanceof A))
                throw e;
            var n = b.makeSpan(["katex-error"], [new d0(t)]);
        ...
        const m4 = function(r, e, t) {
          ...
          , f4 = function(r, e) {
            let t;
            const a = []
              , n = new RegExp("(" + e.map(s=>c4(s.left)).join("|") + ")");
            for (; t = r.search(n),
            t !== -1; ) {
                t > 0 && (a.push({
                    type: "text",
                ...
                if (t = m4(e[s].right, r, e[s].left.length),
                t === -1)
                    break;
                const u = r.slice(0, t + e[s].right.length)
                  , h = d4.test(u) ? u : r.slice(e[s].left.length, t);
                a.push({
                    type: "math",
                    data: h,
                    rawData: u,
          ...
          , p4 = function(r, e) {
            const t = f4(r, e.delimiters);
            if (t.length === 1 && t[0].type === "text")
                return null;
            const a = document.createDocumentFragment();
            for (let n = 0; n < t.length; n++)
                if (t[n].type === "text")
                    a.appendChild(document.createTextNode(t[n].data));
                else {
                    const s = document.createElement("span");
                    let u = t[n].data;
                    e.displayMode = t[n].display;
                    try {
                        e.preProcess && (u = e.preProcess(u)),
                        o1.render(u, s, e)
                    } catch (h) {
                        if (!(h instanceof o1.ParseError))
                            throw h;
                        e.errorCallback("KaTeX auto-render: Failed to parse `" + t[n].data + "` with ", h),
                        a.appendChild(document.createTextNode(t[n].rawData));
                        continue
                    }
                    a.appendChild(s)
                }
            ...
            for (let t = 0; t < r.childNodes.length; t++) {
                ...
                if (a.nodeType === 3) {
                    ...
                    if (h) {
                        ...
                        t += h.childNodes.length - 1,
                        r.replaceChild(h, a)
                    } else
                        t += u
                } else if (a.nodeType === 1) {
                    const n = " " + a.className + " ";
                    e.ignoredTags.indexOf(a.nodeName.toLowerCase()) === -1 && e.ignoredClasses.every(u=>n.indexOf(" " + u + " ") === -1) && h1(a, e)
                }
            }
        }
          , v4 = function(r, e) {
